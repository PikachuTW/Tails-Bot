...
module.exports = async (client, interaction) => {
  ...
  if (interaction.isButton()) {
    ...
    if (interaction.customId == 'ticket_open') {
      let checkTicket = await ticket.findOne({ 'discordid': interaction.member.id });
      let checkTicketOpen = await ticket.findOne({ 'discordid': interaction.member.id, 'closed': false });
